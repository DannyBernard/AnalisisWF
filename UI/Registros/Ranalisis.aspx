...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
				...
				<div class="form-horizontal col-md-12" role="form">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							...
							<button aria-describedby="PacientsDropdownList" type="button" class="btn btn-info" data-toggle="modal" data-target="#TipoBModal" runat="server">+</button>
						</div>
					</div>
					<%--TipoAnalisis--%>
					<div class="form-group">
	...
	<!--Paciente modal-->
	<div class="modal fade" id="TipoBModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog ml-sm-auto" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="AgregarPaciente">Agregar Analisis</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					...
					<div class="modal-footer">
						...
						<asp:Button ID="Button" class="btn btn-success" Text="Guardar" runat="server" data-dismiss="modal" UseSubmitBehavior="false" OnClick="AgregarPaciente_Click" />
					</div>
				</div>
			</div>
		</div>
